...
const EventDetail = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-400 to-pink-300 rounded-r-lg mt-2 mb-10">
      {/* Image on the left */}
      <div className="mr-24 h-1/2 w-1/2 ">
        <UnsplashImage />
      </div>
      ...
      <div className="flex flex-col">
        ...
        {/* Location and Book Event button container */}
        <div className="flex flex-col mt-4">
          <p className="text-gray-600 mb-4">Location: {location}</p>
          <button className="bg-purple-500 hover:bg-gradient-to-r from-orange-400 to-pink-300 py-3 text-white rounded-md w-full transition duration-300 ease-in-out">
